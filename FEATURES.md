...
- **PRO / Premium tiers** — Subscription-gated features (Stripe checkout, billing portal) with a paywall on PRO-only tools. Plans are personal and presented with **Starter** first ($10/year or $1.49/month, PRO for the buyer in one selected league), then **All-Pro** and recommended ($30/year or $4.49/month, PRO for the buyer in up to 5 selected leagues), and **Hall of Fame** ($50/year or $7.49/month, PRO for the buyer in every league they manage). League mates are never upgraded by another manager's purchase. Retired plans (Personal, Individual: One League, Entire League, League + Personal) stay grandfathered for existing subscribers but are no longer sold.
