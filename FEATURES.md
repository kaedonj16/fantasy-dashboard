...
- **PRO / Premium tiers** — Subscription-gated features (Stripe checkout, billing portal) with a paywall on PRO-only tools. Plans are presented with **Personal** first and recommended ($20/year, PRO for the buyer across all their leagues), then **Individual: One League** ($10/year, buyer-only in one selected league), **Entire League** ($35/year, every manager in one selected league), and **League + Personal** ($45/year, the selected league plus the buyer across all their leagues; league mates’ other leagues are not included).
