...
def fix_position_rank_calculation():
    ...
    try:
        ...
        with open('/data_building/update_player_values_with_rankings.py', 'r') as f:
            content = f.read()
    ...
    try:
        ...
        with open('/data_building/update_player_values_with_rankings.py', 'w') as f:
...
def fix_model_training_calculation():
    ...
    try:
        ...
        with open('/data_building/value_model_training.py', 'r') as f:
            content = f.read()
        ...
        if old_line in content:
            ...
            with open('/data_building/value_model_training.py', 'w') as f:
                f.write(updated_content)
