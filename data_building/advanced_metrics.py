...
LEADERBOARD_METRICS: Dict[str, Dict[str, Any]] = {
    ...
    "total_rush_yards":     {"label": "Rush Yards",          "category": "Rushing", "positions": ["RB", "QB"], "integer": True, "desc": "Total rushing yards in the season."},
    ...
    "total_rec_yards":      {"label": "Rec Yards",           "category": "Receiving", "positions": ["WR", "RB", "TE"], "integer": True, "desc": "Total receiving yards in the season."},
