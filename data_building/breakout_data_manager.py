...
def main():
    ...
    print(f"  Scores: {report['scores']['days_old'] or 'N/A'} days old (needs refresh: {report['scores']['needs_refresh']})")
    print(f"  Projections: {report['projections']['days_old'] or 'N/A'} days old (needs refresh: {report['projections']['needs_refresh']})")
    print()
