    ...
    return {
        ...
        "definitions": {
            ...
            "comps": (
                ...
                "COMP_RELAXATION_ORDER. Live Hist compiles nested sibling "
                "buckets (no overlap) until n>=4, then falls back to the parent, "
                "keeping last-year finish and age for a young RB1. The oldest "
                "age band (32+ TE, 31+ RB) waits for n>=15 instead of a 2/2 "
                "self-repeat. Named comps exclude the query player. Live board "
