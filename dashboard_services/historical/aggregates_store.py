...
TEAM_OFFENSE_OVERLAY_PATH = PLAYER_HISTORY_DIR / "team_offense_overlay.json"
...
def load_profile_aggregates(*, path: Optional[Any] = None) -> dict:
    ...
    if path is None:
        ...
        offense_mtime = _file_mtime(TEAM_OFFENSE_OVERLAY_PATH)
    cache_key = (
        mtime, overlay_mtime, volume_mtime, nflverse_mtime, cohort_mtime,
        picks_mtime, index_mtime, draft_picks_mtime, offense_mtime,
    )
