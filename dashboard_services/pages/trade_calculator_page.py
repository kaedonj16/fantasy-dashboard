...
def build_trade_calculator_body(
    ...
    settings_dropdown_block = f"""
              <div class="otc-settings-menu" id="otcSettingsMenu">
                <button type="button" class="otc-settings-toggle-btn" id="otcSettingsBtn"
                        aria-haspopup="true" aria-expanded="false" aria-label="Settings" title="Settings">
                  <svg class="otc-settings-gear" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="vertical-align:-2px;"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>
                </button>
    ...
    scoring_type_js = repr(scoring_type_val)
    return f"""
    <script>var _leagueType = {league_type_js}; var _leagueSize = {num_teams_val}; var _scoringType = {scoring_type_js};</script>
    <div class="otc-layout">
      <main class="otc-main">
        ...
        <input type="hidden" id="leagueScoringTypeInput" value="{_esc(str(scoring_type_val))}">
        ...
        <div class="otc-shell">
          ...
          <div class="otc-builder-grid">
            <section class="otc-team-card">
              <div class="otc-team-head">
                <div>
                  <h2 class="otc-team-title" id="sideATitle">Team 1 gets...</h2>
                </div>
          ...
          <style>
            ...
            .pi-roster-warn i {{ color:var(--warning);margin-top:1px;flex-shrink:0; }}
            ...
            .stl-badge-sf {{ background:color-mix(in srgb, var(--indigo) 15%, transparent);color:var(--indigo);border-color:color-mix(in srgb, var(--indigo) 32%, transparent); }}
