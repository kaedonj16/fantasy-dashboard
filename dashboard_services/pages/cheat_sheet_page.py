...
<div class="cs-wrap">
  ...
  <section class="cs-hidden" id="cs-panel-logic">
    <div class="cs-prose">
      ...
      <div class="cs-rule"><span class="cs-k">Proj PPG</span><div><h3>Expected weekly scoring</h3><p>Projected PPG is the player's upcoming-season fantasy points per game from the same projection pool used by the Draft Room. Players missing a season projection fall back to last-season actual PPG (shown muted) rather than a blank cell.</p></div></div>
