...
<div class="cs-wrap">
  ...
  <section class="cs-hidden" id="cs-panel-logic">
    <div class="cs-prose">
      ...
      <div class="cs-rule"><span class="cs-k">Hist</span><div><h3>Hist vs the ADP bucket</h3><p>On the redraft Big Board, Hist is the signed gap between this player's historical top-12 rate and the rate for anyone taken in that ADP round. Green means history is higher; red means that ADP round is higher. Absolute rates and similar-player examples live in the info panel. The Trends tab is position-wide research (repeats, capital, age, usage) and stays available in dynasty with a 1QB redraft caveat. Hist does not change VOR or Pick Score.</p></div></div>
