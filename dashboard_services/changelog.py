...
CHANGELOG = [
    {
        "date": "2026-09-03",
        "tag": "new",
        "text": "Advanced Metrics: pick more than one season (2025 + 2024 + 2022, or any years we have). Those years combine into one row per player (rates volume-weighted, totals added). In a player modal, tap extra year pills to combine only seasons that player actually has; Career still uses every year.",
        "link": "/metrics"
    },
    {
        "date": "2026-09-01",
