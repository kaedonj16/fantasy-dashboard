...
def format_player_stats(
    ...
    # ---------------- K / PK ----------------
        ...
        has_fg_made = any(k in player_stats for k in
                          ("fgm", "fg_made", "field_goals_made"))
        has_fg_att = any(k in player_stats for k in
                         ("fga", "fg_att", "field_goals_attempted"))
        has_xp_made = any(k in player_stats for k in
                          ("xpm", "xp_made", "pat_made", "extra_points_made"))
        has_xp_att = any(k in player_stats for k in
