...
- **Mobile:** ESPN usually forces the Fantasy app (no bookmarklets). Prefer
  manual tracking in Draft Room, or a laptop + extension. **Mobile Sync** only
  helps if Request Desktop Website still shows the live draft board.
