  ...
  function openEspnMobileSync(){
    function renderPanel(){
      ...
      msg.innerHTML = ''
        ...
        + '<li>Under <b>Receive</b> / Share Sheet types: turn <b>everything OFF</b> except <b>Safari web pages</b>. The top line must <b>not</b> say “Apps and 18 more” — it should say something like “Receive Safari web pages from Share Sheet.”</li>'
        + '<li>Add action <b>Run JavaScript on Web Page</b> → blue chip → <b>Shortcut Input</b>.</li>'
        + '<li>Paste <b>Copy iOS Shortcut JS</b> (not the bookmarklet; must not start with <code>javascript:</code>).</li>'
        + '<li>Do <b>not</b> press Play inside Shortcuts. Open ESPN in <b>Safari</b> (desktop site) → Share → <b>BR Fantasy sync</b>.</li>'
        + '</ol></div>'
        + '<div class="dr-msync-sec"><h4>iPhone alternate: bookmark via Mac</h4>'
        + '<ol>'
        + '<li>On iPhone Safari, bookmark the ESPN draft page.</li>'
        + '<li>On a Mac with the same Apple ID, edit that bookmark\'s URL to the bookmarklet (<code>javascript:…</code>), then sync back.</li>'
        + '</ol></div>'
